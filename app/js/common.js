...
$(function () {
    ...
    var $status = $('.count-partners-slider');
...
$(function () {
    ...
    $(document).keyup(function (e) {
        if(e.which == 27) toggleMenu('close');
    });

    $('.nav, .header-container').click(function (e) {
        if($(e.target).hasClass('nav') || $(e.target).hasClass('header-container')){
            toggleMenu('close');
        }
        // === true ? toggleMenu() : false
    })
